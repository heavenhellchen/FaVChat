...
for dataset_name in ['your_data_name']:
    ...
    OUTPUT_PATH = f"./src/r1-v/FaVChat-data/{dataset_name}_COT_qwen72b.json"
    PROMPT_PATH = f"./src/r1-v/FaVChat-data/{dataset_name}.json"
    ...
    for x in data:
        ...
        msg = [{
            ...
            "content": [
                {
                    "type": x['data_type'],
                    x['data_type']: os.getcwd() + "/src/r1-v/FaVChat-data" + x['path'][1:]
                },
                {
                    "type": "text",
